/*! jQuery v2.1.4 | (c) 2005, 2015 jQuery Foundation, Inc. | jquery.org/license */ ! function(a, b) {
	...
	n.event = {
		...
		trigger: function(b, c, d, e) {
			...
			if (g = h = d = d || l, 3 !== d.nodeType && 8 !== d.nodeType && !X.test(q + n.event
				.triggered) && (q.indexOf(".") >= 0 && (r = q.split("."), q = r.shift(), r.sort()), k = q
					...
					b.namespace ? new RegExp("(^|\\.)" + r.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, b
		...
		return this instanceof n.Event ? (a && a.type ? (this.originalEvent = a, this.type = a.type, this
				...
				.returnValue === !1 ? Z : $) : this.type = a, b && n.extend(this, b), this.timeStamp = a &&
		...
		on: function(a, b, c, d, e) {
			...
			if (null == c && null == d ? (d = b, c = b = void 0) : null == d && ("string" == typeof b ?
					(d = c, c = void 0) : (d = c, c = b, b = void 0)), d === !1) d = $;
	...
	n.fn.extend({
		...
		$a[b] = function(a, b, d) {
			var e, f;
			return d || (f = $a[b], $a[b] = e, e = null != c(a, b, d) ? b.toLowerCase() : null, $a[b] =
				f), e
		}
	});
		...
		ajax: function(a, b) {
			...
			i = n.event && k.global, i && 0 === n.active++ && n.event.trigger("ajaxStart"), k.type = k
				.type.toUpperCase(), k.hasContent = !ib.test(k.type), d = k.url, k.hasContent || (k
					...
					.cache === !1 && (k.url = fb.test(d) ? d.replace(fb, "$1_=" + cb++) : d + (db.test(
	...
	n.ajaxSetup({
		...
		return h || "jsonp" === b.dataTypes[0] ? (e = b.jsonpCallback = n.isFunction(b.jsonpCallback) ? b
			.jsonpCallback() : b.jsonpCallback, h ? b[h] = b[h].replace(Gb, "$1" + e) : b.jsonp !== !
